...
Video_save_path1="${TEMP}/${INPUT_NAME}_half.mp4"
...
OUT_DIR="${TEMP}/${INPUT_NAME}_half_ghost_035.mp4"
...
python3 controlnet_img2video.py \
        $Video_save_path1 \
        --sd-model $SD_MODEL \
        --sd-vae $SD_VAE  \
        --controlnet hed \
