...
def run(args, text_encoder, vae, unet):
    ...
    # モデルを読み込む
    # print("os.path.isfile(args.ckpt):", os.path.isfile(args.ckpt))
    ...
    use_stable_diffusion_format = True


    # if not use_stable_diffusion_format:
        # print("1111111111")
        # print("load StableDiffusion checkpoint")
        # text_encoder = args.sd_text_encoder
        # vae = args.sd_vae
        # unet = args.sd_unet
...
def setup_parser() -> argparse.ArgumentParser:
    ...
    # parser.add_argument("--sd_text_encoder",  default=None)
    # parser.add_argument("--sd_unet",  default=None)
    # parser.add_argument("--sd_vae", default=None)
    return parser
