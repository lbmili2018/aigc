python gen_img_diffusers_video.py --ckpt /root/algo/stable-diffusion-webui/models/Stable-diffusion/GuoFeng3/GuoFeng3.2.safetensors \
    --outdir /root/limiao/result/res_video_guofeng_mfr_06/ --xformers --fp16 --scale 7 --sampler euler_a --steps 20 \
...
#python gen_img_diffusers_video.py --ckpt /root/algo/stable-diffusion-webui/models/Stable-diffusion/WAVE-P.ckpt \
#    --outdir /root/limiao/result/res_video_manhua_mfr/ --xformers --fp16 --scale 7 --sampler euler_a --steps 20 \
#    --image_path /root/limiao/DeforumStableDiffusionLocal/output/2023-05/WAVE_ext1_stren06_euler_a_512_512/inputframes/ --strength 0.4 \
#    --H 768 --W 512 \
#    --seed  12312321313 \
