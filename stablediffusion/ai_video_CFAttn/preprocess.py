...
def merge_video(data_path1, data_path2, out_dir, fps, data_path3=None):
    ...
    for i in range(len(im_list2)):
        ...
        cv2.putText(image, "orig_0.75", (5,50 ), cv2.FONT_HERSHEY_SIMPLEX, 0.75, (0, 0, 255), 2)
        res2 = cv2.imread(res2)
        cv2.putText(res2, "CrossAttention_0.75", (5,50 ), cv2.FONT_HERSHEY_SIMPLEX, 0.75, (0, 0, 255), 2)
        if data_path3:
...
if __name__ == '__main__':
    ...
    if args.EXTRACT_RIFE:
        ...
        # compare video
        data_path1 = "/root/limiao/controlnetvideo_test/user/temp/black_res_orig_075/"
        data_path2 = "/root/limiao/controlnetvideo_test/user/temp/black_res11_075_all/"
        # data_path3 = "/root/limiao/controlnetvideo/split/black_half_out_test_style_vae_035_2X_48fps/"
        out_dir="/root/limiao/controlnetvideo_test/user/temp/final_res_075.mp4"
        fps = 24
        merge_video(data_path1, data_path2, out_dir, fps, data_path3=None)


    # videos_path = "/root/limiao/controlnetvideo_test/user/temp/black_res_orig_075.mp4"
    # frames_save_path = "/root/limiao/controlnetvideo_test/user/temp/black_res_orig_075/"
