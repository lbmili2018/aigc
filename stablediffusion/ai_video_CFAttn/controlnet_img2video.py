...
def main(input_video, output_video, start_time, end_time,
	...
	if controlnet == 'canny':
		...
		#sdmodel = './checkpoints/toonyou_beta1.safetensors/'
	...
	def frame_filter(framenum, input_frame):
		...
		print("1 {}, {}".format(input_frame.width, input_frame.height))
		...
		# else:
		#   input_frame = input_frame.resize((input_frame.width, input_frame.height), PIL.Image.BICUBIC)
		  
		print("2 {}, {}".format(input_frame.width, input_frame.height))
		...
		#
		# print("3 {}".format(input_gray.shape))
		#
		# output_frame = None
		# skipped = False
		# skipped_frame = None
		...
		# #print("4 {}, {}".format(output_frame.width, output_frame.height))
		...
		new_init_image = []
		new_init_image.extend([init_image] * num_img_per_prompt)
		init_image = new_init_image
		# generator = [torch.Generator(device='cuda').manual_seed(1024) for i in range(num_img_per_prompt)]
		...
		if output_frame == None:
			...
			a = time.time()
			output_frame = pipe(
				prompt=[prompt] * num_img_per_prompt,
				guidance_scale=prompt_strength,
				negative_prompt=[negative_prompt]* num_img_per_prompt,
				num_inference_steps=num_inference_steps,
				generator=generator,
				controlnet_conditioning_image=[control_image] * num_img_per_prompt, # one
		...
		print("5 {}, {}".format(output_frame.width, output_frame.height))
		...
		print("6 {}, {}".format(output_frame.width, output_frame.height))
		...
		# print("7 {}, {}".format(motion_image.width, motion_image.height))
		...
		# print("8 {}, {}".format(final_frame.width, final_frame.height))
		# if color_info:
		...
		# print("9 {}, {}".format(final_frame.width, final_frame.height))
		...
		# print("10 {}, {}".format(final_frame.width, final_frame.height))
