...
class StableDiffusionControlNetImg2ImgPipeline(DiffusionPipeline):
    ...
    def check_inputs(
        ...
        print("controlnet_cond_image_batch_size:", controlnet_cond_image_batch_size, prompt_batch_size)
    ...
    def prepare_latents(self, image, timestep, batch_size, num_images_per_prompt, dtype, device, generator=None, seed=None, noise=None, blend_noise=None):
